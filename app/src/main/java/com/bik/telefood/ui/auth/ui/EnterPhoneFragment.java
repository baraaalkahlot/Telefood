...
public class EnterPhoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FragmentEnterPhoneBinding binding = FragmentEnterPhoneBinding.inflate(inflater, container, false);
        binding.btnSendCode.setOnClickListener(v -> NavHostFragment.findNavController(this).navigate(R.id.navigation_enter_confirm_code));
