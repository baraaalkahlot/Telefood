...
public class FeaturedServicesAdapter extends RecyclerView.Adapter<FeaturedServicesAdapter.ViewHolder> {
    private List<ServicesItemModel> servicesItemModels;
    private OnProductClickListener onProductClickListener;
    private Context context;

    public FeaturedServicesAdapter(List<ServicesItemModel> servicesItemModels, OnProductClickListener onProductClickListener, Context context) {
